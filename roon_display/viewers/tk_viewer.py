...
class TkViewer(BaseViewer):
    ...
    def __init__(self, config, root):
        ...
        # Set screen size from root window
    ...
    def check_pending_updates(self):
        ...
        if self.pending_image_data is not None:
            image_key, image_path, title = self.pending_image_data
            self.display_image(image_key, image_path, title)
    ...
    def update(self, image_key, image_path, img, title):
        ...
        self.pending_image_data = (image_key, image_path, title)
